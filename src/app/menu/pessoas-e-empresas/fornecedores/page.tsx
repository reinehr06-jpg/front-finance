      ...
      <div className="flex-1 ml-[240px] flex flex-col h-screen overflow-hidden">
        ...
        <main className="p-4 flex-1 flex flex-col w-full max-w-[1600px] mx-auto gap-4 overflow-hidden">
          ...
          <div className="flex items-center justify-between shrink-0 bg-white rounded-[12px] p-4 border border-[#E5E7EB] shadow-sm">
            ...
            <Link href="/menu/pessoas-e-empresas/fornecedores/novo" className="bg-[#6D28D9] hover:bg-[#5B21B6] transition-colors text-white px-4 py-2 rounded-[8px] text-[12px] font-[600] flex items-center gap-2 shadow-sm">
                ...
                <tbody>
                  <tr className="hover:bg-[#F9FAFB] transition-colors border-b border-[#F1F1F4]">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex flex-col">
                        <Link href="/menu/pessoas-e-empresas/fornecedores/1" className="text-[13px] font-[700] text-[#6D28D9] hover:underline">Imobiliária Souza Ltda</Link>
                      </div>
                    </td>
                    ...
                    <td className="py-3 px-4 text-center">
                      <Link href="/menu/pessoas-e-empresas/fornecedores/1" className="inline-flex items-center justify-center w-[32px] h-[32px] rounded-[6px] text-[#9CA3AF] hover:bg-[#F3E8FF] hover:text-[#5B21B6] transition-colors">
