        ...
        <main className="p-[0_24px_24px_24px] flex-1 flex flex-col overflow-y-auto custom-scrollbar">
          ...
          <div className="flex items-center gap-[14px] py-[16px]">
            ...
            <div className="flex flex-col justify-center">
              <h1 className="text-[24px] font-[700] text-[#1A1A2E] leading-tight">Nova Categoria</h1>
              <p className="text-[13px] font-[500] text-[#6B7280] mt-0.5">Cadastre uma categoria para receitas ou despesas.</p>
            </div>
          </div>
