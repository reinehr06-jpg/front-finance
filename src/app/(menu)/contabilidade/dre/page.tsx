 ...
 *
 * 📍 ROTA: /dre
 * 📁 ARQUIVO: src/app/dre/page.tsx
 *
 * 🎯 OBJETIVO DESTA TELA:
 *    Exibir o Demonstrativo de Resultados do Exercício (DRE) da igreja, mostrando
 *    receitas, deduções, despesas e o resultado líquido (superávit/déficit).
 *
 * 🔗 INTEGRAÇÕES COM O BACK-END:
 *    1. GET /api/dre?mes=2024-05&filial_id=todas → Retorna os dados estruturados do DRE
 *    2. POST /api/dre/exportar → Exportar o DRE atual para PDF
 *
 * 📌 REGRAS DE NEGÓCIO:
 *    - O DRE é gerado por competência (data do fato gerador) ou caixa (recebimento/pagamento), 
 *      conforme configuração da igreja.
 *    - As linhas podem ser expandidas (ex: clicar em "Receitas Totais" abre "Dízimos", "Ofertas").
 *
 * ═══════════════════════════════════════════════════════════════════════════════
 */
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar p-0 m-0">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    ...
                    {/* DEDUÇÕES DA RECEITA (Opcional - deixando zerado para visual de DRE) */}
                    ...
                    {/* RESULTADO ANTES DOS INVESTIMENTOS E IMPOSTOS (EBITDA Simulado) */}
                    <tr className="bg-[#F9FAFB] border-b border-[#E5E7EB]">
                      <td className="py-4 px-6 flex items-center gap-2">
                        <div className="w-[16px]"></div>
