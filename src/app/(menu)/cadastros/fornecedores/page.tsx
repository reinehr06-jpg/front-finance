                ...
                <tbody>
                  <tr className="hover:bg-[#F9FAFB] transition-colors border-b border-[#F1F1F4]">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex flex-col">
                        <Link href="/cadastros/fornecedores/1" className="text-[13px] font-[700] text-[#6D28D9] hover:underline">Imobiliária Souza Ltda</Link>
                      </div>
                    </td>
                    ...
                    <td className="py-3 px-4 text-center">
                      <Link href="/cadastros/fornecedores/1" className="inline-flex items-center justify-center w-[32px] h-[32px] rounded-[6px] text-[#9CA3AF] hover:bg-[#F3E8FF] hover:text-[#5B21B6] transition-colors">
